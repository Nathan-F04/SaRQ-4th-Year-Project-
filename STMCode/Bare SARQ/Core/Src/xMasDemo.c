...
void userApp() {
	...
	while (1) {
		...
		case 1:
			...
			printf("Servo TIM16 CH1 angle is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM16->CCR1 = CCR_Return;
			printf("Servo angle TIM16 CH1 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			...
			printf("Servo angle TIM4 CH4 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM4->CCR4 = CCR_Return;
			...
			printf("Servo angle TIM2 CH1 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM2->CCR1 = CCR_Return;
			...
			printf("Servo angle TIM3 CH1 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM3->CCR1 = CCR_Return;
			...
			printf("Servo angle TIM3 CH2 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM3->CCR2 = CCR_Return;
			...
			printf("Servo angle TIM2 CH3 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM2->CCR3 = CCR_Return;
			...
			printf("Servo angle TIM3 CH4 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM3->CCR4 = CCR_Return;
			...
			printf("Servo angle TIM5 CH4 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM5->CCR4 = CCR_Return;
			...
			printf("Servo angle TIM3 CH3 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM3->CCR3 = CCR_Return;
			...
			printf("Servo angle TIM4 CH3 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM4->CCR3 = CCR_Return;
			...
			printf("Servo angle TIM5 CH1 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM5->CCR1 = CCR_Return;
			...
			printf("Servo angle TIM2 CH2 is %hu\r\n\n", anglePassed);
			HAL_Delay(2000);
			anglePassed = 180;
			CCR_Return = servo(anglePassed);
			TIM2->CCR2 = CCR_Return;
